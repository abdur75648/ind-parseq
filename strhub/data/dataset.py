...
class LmdbDataset(Dataset):
    ...
    def __init__(self, root: str, charset: str, max_label_len: int, min_image_dim: int = 0,
                 ...
                 unlabelled: bool = False, transform: Optional[Callable] = None, flip_left_right=True):
        self._env = None
        self.root = root
    ...
    def __getitem__(self, index):
        ...
        # import random
        # transform_it = T.ToPILImage()
        # num_omg = random.randint(1,1000)
        # transform_it(img).save(str(num_omg)+".jpg")
        # print("Label of "+ str(num_omg) + ".jpg:\t",label)
        # exit()
        return img, label
